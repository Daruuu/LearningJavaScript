...
console.log(
  `Welcome to Texas Hold'em. \nThe championship title will be awarded to one of these three players: ${playerOneName}, ${playerTwoName} and ${playerThreeName}.\nEach player has ${STARTING_POKER_CHIPS} in their pot. We have an exciting game ahead of us. May the best player win!`
);
...
gameHasEnded =
  ((playerOnePoints + playerTwoPoints) == 0) || // three has won
